...
public class banking_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(schemeList, SchemeSector.BANKING.getDisplayName());
    ...
    private void initializeViews() {
        ...
        headerTitle.setText("Banking Sector");
        ...
        notificationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent notificationList = new Intent(banking_activity.this, NotificationListActivity.class);
        ...
        govtSchemesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent govtSchemes = new Intent(banking_activity.this, GovernmentSchemesActivity.class);
                govtSchemes.putExtra(GovernmentSchemesActivity.EXTRA_SECTOR, SchemeSector.BANKING.name());
    ...
    private void loadSchemesFromDatabase() {
        ...
        SchemeDataProvider.getSchemesForSector(SchemeSector.BANKING, new SchemeDataProvider.SchemeListCallback() {
            @Override
            ...
            public void onError(String errorMessage) {
                ...
                Toast.makeText(banking_activity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        class SchemeViewHolder extends RecyclerView.ViewHolder {
            ...
            private void openUrl(String url) {
                try {
                    ...
                    Toast.makeText(banking_activity.this,
                            "Could not open URL",
