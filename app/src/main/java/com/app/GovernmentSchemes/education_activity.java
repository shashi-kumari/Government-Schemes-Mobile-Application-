...
public class education_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(schemeList, SchemeSector.EDUCATION.getDisplayName());
    ...
    private void initializeViews() {
        ...
        headerTitle.setText("Education Sector");
        ...
        notificationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent notificationList = new Intent(education_activity.this, NotificationListActivity.class);
    ...
    private void loadSchemesFromDatabase() {
        ...
        SchemeDataProvider.getSchemesForSector(SchemeSector.EDUCATION, new SchemeDataProvider.SchemeListCallback() {
            ...
            public void onError(String errorMessage) {
                ...
                Toast.makeText(education_activity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
