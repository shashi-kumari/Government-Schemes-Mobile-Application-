...
public class health_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(schemeList, SchemeSector.HEALTH.getDisplayName());
    ...
    private void initializeViews() {
        ...
        headerTitle.setText("Health Sector");
        ...
        notificationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent notificationList = new Intent(health_activity.this, NotificationListActivity.class);
    ...
    private void loadSchemesFromDatabase() {
        ...
        SchemeDataProvider.getSchemesForSector(SchemeSector.HEALTH, new SchemeDataProvider.SchemeListCallback() {
            @Override
            ...
            public void onError(String errorMessage) {
                ...
                Toast.makeText(health_activity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        class SchemeViewHolder extends RecyclerView.ViewHolder {
            ...
            private void openUrl(String url) {
                try {
                    ...
                    Toast.makeText(health_activity.this,
                            "Could not open URL",
