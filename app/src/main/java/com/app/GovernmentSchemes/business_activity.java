...
public class business_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(schemeList, SchemeSector.BUSINESS.getDisplayName());
    ...
    private void initializeViews() {
        ...
        headerTitle.setText("Business Sector");
        ...
        notificationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent notificationList = new Intent(business_activity.this, NotificationListActivity.class);
    ...
    private void loadSchemesFromDatabase() {
        ...
        SchemeDataProvider.getSchemesForSector(SchemeSector.BUSINESS, new SchemeDataProvider.SchemeListCallback() {
            @Override
            ...
            public void onError(String errorMessage) {
                ...
                Toast.makeText(business_activity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        class SchemeViewHolder extends RecyclerView.ViewHolder {
            ...
            private void openUrl(String url) {
                try {
                    ...
                    Toast.makeText(business_activity.this,
                            "Could not open URL",
