...
public class Agriculture_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(schemeList, SchemeSector.AGRICULTURE.getDisplayName());
    ...
    private void initializeViews() {
        ...
        headerTitle.setText("Agriculture Sector");
        ...
        notificationIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent notificationList = new Intent(Agriculture_activity.this, NotificationListActivity.class);
    ...
    private void loadSchemesFromDatabase() {
        ...
        SchemeDataProvider.getSchemesForSector(SchemeSector.AGRICULTURE, new SchemeDataProvider.SchemeListCallback() {
            @Override
            ...
            public void onError(String errorMessage) {
                ...
                Toast.makeText(Agriculture_activity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        class SchemeViewHolder extends RecyclerView.ViewHolder {
            ...
            private void openUrl(String url) {
                try {
                    ...
                    Toast.makeText(Agriculture_activity.this,
                            "Could not open URL",
